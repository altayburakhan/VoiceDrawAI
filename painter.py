...
def generate_image_with_dalle(prompt):
    ...
    filename = f"./img/generated_image{timestamp}.png"
...
def gemini_vision_with_local_file(image_path, prompt):
    ...
    multimodality_prompt = f"""Bu gonderdigim resmi, bazi ek yonergelerle birlikte yeniden olusturmani istiyorum. Bunun icin ilk olarak resmi son derece ayrintili bicimde betimle. 
     Daha sonra sonucunda bana verecegin metni, bir yapay zeka modelini kullanarak gorsel olusturmakta kullanacagim. O yuzden yanitina son halini verirken bunun resim uretmek icin kullanilacak bir girdi 
     yani prompt oldugunu dikkate al. Iste yonergeler soyle: {prompt}
